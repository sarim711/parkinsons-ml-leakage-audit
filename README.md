...
the benchmark actually supports once patients are held out properly. The earlier work is kept
in `legacy/`.
...
- `legacy/`
  - The superseded Explainable AI and adversarial-robustness direction, kept for the record.
